...
const routes: Routes = [
  ...
  //client Routing
  {
    path: 'client/product/addProduct/:clientId',
    component: AddProductComponent,
  },
  {
    path: 'client/product/viewProduct/:productId',
    component: FetchProductComponent,
  },
  {
    path: 'client/product/deleteProduct/:productId/:clientId',
    component: DeleteProductComponent,
  },
  {
    path: 'client/product/UpdateProduct/:productId/:clientId',
    component: UpdateProductComponent,
  },
  {
    path: 'client/product/productList/:clientId',
    component: ProductListComponent,
  },
  {
    path: 'client/logged/complaintHistory/:clientId/:complaintId',
    component: ListOfComplaintsComponent,
  },
  {
    path: 'client/complaint/allComplaints/:clientId',
    component: AllComplaintsComponent,
  },
  {
    path: 'client/logged/product/bookComplaint/:productId/:clientId/:modelNumber',
  ...
  {
    path: 'admin/listOfEngineer/updateDomain/:engineerId',
    component: UpdateEngDomainComponent,
  },
  {
    path: 'admin/listOfEngineer/delete/:engineerId',
    component: DeleteEngineerComponent,
  },
  ...
  {
    path: 'engineer/engComplaints/engCloseComplaints/:id',
    component: CloseComplaintEngComponent,
  },
  {
    path: 'engineer/engComplaints/engOpenComplaints/:id',
    component: OpenComplaintEngComponent,
  },
  {
    path: 'engineer/engComplaints/allComplaints/:id',
    component: AllComplaintsEngComponent,
  },
];
